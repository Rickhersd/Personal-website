    ...
    <nav className='w-full p-4 flex fixed sm:absolute top-0 z-50 bg-zinc-50 dark:bg-zinc-800 justify-between items-center '>
      ...
      <ul className="flex flex-row justify-center gap-2 items-center">
        <ListRender className='flex items-center justify-center text-base font-medium p-3'>
          <AnchorItem className='hidden md:block' href={`/${lang}/about`}>Sobre mi</AnchorItem>
          <AnchorItem className='hidden md:block' href={`/${lang}/blog`}>Blog</AnchorItem>
          <AnchorItem className='hidden md:block' href={`/${lang}/projects`}>Portfolio</AnchorItem>
          <AnchorItem className='hidden md:block' href={`/${lang}/contact`}>Contacto</AnchorItem>
